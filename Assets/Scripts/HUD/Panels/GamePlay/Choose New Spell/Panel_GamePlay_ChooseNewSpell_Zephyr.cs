...
public class Panel_GamePlay_ChooseNewSpell_Zephyr : Panel
{
    ...
    public TextMeshProUGUI TXT_Btn_FireSpells;
    public TextMeshProUGUI TXT_Btn_ThunderSpells;
    public TextMeshProUGUI TXT_Btn_IceSpells;
    ...
    public override void AbrirPainel(object param1 = null, object param2 = null, object param3 = null)
    {
        ...
        TXT_Btn_FireSpells.text = LanguageManager.Get(LanguageTexts_BasicWords.BasicWords.Spell_Element_Fire);
        TXT_Btn_ThunderSpells.text = LanguageManager.Get(LanguageTexts_BasicWords.BasicWords.Spell_Element_Thunder);
        TXT_Btn_IceSpells.text = LanguageManager.Get(LanguageTexts_BasicWords.BasicWords.Spell_Element_Ice);
