...
public class Panel_MainMenu_Play_SelecaoPersonagem : Panel
{
    ...
    {
        TXT_SelectCharacter.text = LanguageManager.Get(LanguageTexts_Panel_MainMenu.MainMenuWords.SelectCharacter);
        TXT_PlayerMoneyValue.text = PlayerConfig.playerMoney.ToString();

        TXT_Btn_Back.text = LanguageManager.Get(LanguageTexts_BasicWords.BasicWords.Back);
