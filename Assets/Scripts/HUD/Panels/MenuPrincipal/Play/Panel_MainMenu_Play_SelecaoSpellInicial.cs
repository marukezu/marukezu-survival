...
public class Panel_MainMenu_Play_SelecaoSpellInicial : Panel
{
    ...
    private void Awake()
    {
        ...
        TXT_SelectFirstSpell.text = LanguageManager.Get(LanguageTexts_Panel_MainMenu.MainMenuWords.SelectFirstSpell);
        TXT_BtnBack_SelectWeapon.text = LanguageManager.Get(LanguageTexts_BasicWords.BasicWords.Back);
    }
