...
public class Panel_MainMenu_Bestiary : Panel
{
    ...
    public override void AbrirPainel(object param1 = null, object param2 = null, object param3 = null)
    {
        ...
        TXT_BestiaryBestiary.text = LanguageManager.Get(LanguageTexts_BasicWords.BasicWords.No);
        TXT_BestiaryBack.text = LanguageManager.Get(LanguageTexts_BasicWords.BasicWords.Back);
    }
